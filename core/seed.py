...
event_data = [
    ...
    },
    {
        ...
        'short_desc': 'Pierjam brings its iconic electronic music festival vibe right to the scenic setting of Hastings Pier.\nDance the day away over the ocean waves with world-class DJs, open-air stages, and an unforgettable seaside party atmosphere.',
    },
    {
        'location': 'Milton Keynes Stadium MK',
        ...
        'ticket_link' : 'https://skiddle.com/events?id=123940569304',
        'title' : 'GARAGE NATION',
        'short_desc': 'The ultimate celebration of UK Garage music takes over Milton Keynes Stadium MK for a massive, nostalgia-fueled showcase.\nFeaturing a huge lineup of legendary MCs and DJs, this event brings the finest old-school anthems and garage riddims back to life.',
    },
    {
        'location': 'The Oval, Bohemia Road, Hastings, TN34 1EU',
        'date' : date.today() - timedelta(days=1065),
        'ticket_link' : 'https://skiddle.com/events?id=123940569304',
        'title' : 'HASTINGS REGGAE FESTIVAL',
